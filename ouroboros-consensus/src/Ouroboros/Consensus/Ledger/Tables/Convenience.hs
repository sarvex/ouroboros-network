...
module Ouroboros.Consensus.Ledger.Tables.Convenience (
...
emptyLedgerTables :: TableStuff l => LedgerTables l EmptyMK EmptyMK
emptyLedgerTables = polyEmptyLedgerTables

-- | Empty values for every table
polyEmptyLedgerTables :: forall mk1 mk2 l. (TableStuff l, IsApplyMapKind mk1, IsApplyMapKind mk2) => LedgerTables l mk1 mk2
polyEmptyLedgerTables = pureLedgerTables (emptyAppliedMK sMapKind) (emptyAppliedMK sMapKind)

-- -- Forget all

forgetLedgerTables :: TableStuff l => l mk1 mk2 -> l EmptyMK EmptyMK
