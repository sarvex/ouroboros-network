  ...
  let bearerInfo = AbsBearerInfo {
      ...
      diffScript = DiffusionScript
        ...
        [( NodeArgs (-3) InitiatorAndResponderDiffusionMode (Just 224)
             ...
             NoPeerSharing
             [(1,Map.fromList [(RelayAccessAddress "0.0.0.8" 65531,DoNotAdvertisePeer)])]
             nullPeerSelectionTargets {
                 targetNumberOfRootPeers = 2,
                 targetNumberOfKnownPeers = 5,
         ...
         ( NodeArgs (-5) InitiatorAndResponderDiffusionMode (Just 269)
             ...
             NoPeerSharing
             [(1,Map.fromList [(RelayAccessAddress "0.0.0.4" 9,DoNotAdvertisePeer)])]
             nullPeerSelectionTargets {
         ...
         , [ JoinNetwork 3.384615384615 Nothing,
             Reconfigure 3.583333333333 [(1,Map.fromList [(RelayAccessAddress "0.0.0.4" 9,DoNotAdvertisePeer)])],
             Kill 15.55555555555,
