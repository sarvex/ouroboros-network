...
prop_governor_target_established_public env =
    let events = Signal.eventsFromListUpToTime (Time (2 * 60 * 60))
               . selectPeerSelectionTraceEvents
               . runGovernorInMockEnvironment
               $ env
...
prop_issue_3550 = prop_governor_target_established_below $
  GovernorMockEnvironment {
      ...
      localRootPeers = LocalRootPeers.fromGroups [(1,Map.fromList [(PeerAddr 16,DoAdvertisePeer)]),(1,Map.fromList [(PeerAddr 4,DoAdvertisePeer)])],
...
prop_issue_3515 = prop_governor_nolivelock $
  GovernorMockEnvironment {
      ...
      localRootPeers = LocalRootPeers.fromGroups [(1,Map.fromList [(PeerAddr 10,DoAdvertisePeer)])],
      publicRootPeers = Map.fromList [],
      bigLedgerPeers = Set.empty,
      targets = Script
...
prop_issue_3494 = prop_governor_nofail $
  GovernorMockEnvironment {
      ...
      localRootPeers = LocalRootPeers.fromGroups [(1,Map.fromList [(PeerAddr 64,DoAdvertisePeer)])],
      publicRootPeers = Map.fromList [],
      bigLedgerPeers = Set.empty,
      targets = Script
        (( nullPeerSelectionTargets,NoDelay)
...
prop_issue_3233 = prop_governor_nolivelock $
  GovernorMockEnvironment {
      ...
      localRootPeers = LocalRootPeers.fromGroups [(1,Map.fromList [(PeerAddr 15,DoAdvertisePeer)]),(1,Map.fromList [(PeerAddr 13,DoAdvertisePeer)])],
